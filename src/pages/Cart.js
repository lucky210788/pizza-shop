...
import {addToCartOneItem, clearCart, removeCartItem, removeFromCartOneItem} from "../redux/actions/cart";
...
function Cart() {
    ...
    const onRemoveOneItem = (id) => {
        dispatch(removeFromCartOneItem(id));
    }

    const onAddOneItem = (id) => {
        dispatch(addToCartOneItem(id));
    }
                    ...
                    <div className="content__items">
                        {
                            addedPizzas.map(obj => <CartItem
                                ...
                                onRemoveOne={onRemoveOneItem}
                                onAddOne={onAddOneItem}
                            />)
                        }
                    </div>
